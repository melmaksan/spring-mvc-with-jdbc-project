...
public class Main {
    ...
    private static void tagRun(TagService tagService) {
        ...
        if (dlt > 0) {
            ...
            System.out.println("Tag with name patriot and " + tag.getName() + " were deleted" + "\n");
        } else {
            System.out.println("Tag with name patriot and " + tag.getName() + " wasn't deleted, please try again" + "\n");
        }
